...
namespace quickpossecure.Controllers.Api
{
    ...
    public class MainApiController : Controller
    {
        ...
        public dynamic customer_getall()
        {
            ...
            var data = from d in db.Customer.ToList() select new {
                Id= d.Id,
                Name=d.Name,
                Email = d.Email,
                Address = d.Address,
        ...
        {
            MyDbContext db = new MyDbContext();
            var data = from d in db.Vendor.ToList() select new {
                Id = d.Id,
                Name= d.Name,
                Email=d.Email,
                Address=d.Address,
        ...
        {
            MyDbContext db = new MyDbContext();
            var data = from d in  db.Manufacturer.ToList() select new {
                Id = d.Id,
                Name = d.Name,
            };
            return data.ToList();
        ...
        public dynamic Category_getall()
        {
            ...
            var data = from d in db.Category.ToList() select new {
                Id = d.Id,
                Name = d.Name,
            };
            return data.ToList();
        ...
        public dynamic product_getall(string Type="",bool ActiveOnSale = false,bool ActiveOnPurchase = false)
        {
            ...
            var data = from d in list select new {
                Id = d.Id,
                Name = d.Name,
        ...
        {
            MyDbContext db = new MyDbContext();
            var data= from d in db.FinanceAccount.Include(a => a.FkParent).ToList() select new {
                Id=d.Id,
                Name=d.Name,
